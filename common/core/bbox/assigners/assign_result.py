...
class AssignResult:
    ...
    def random(cls, **kwargs):
        ...
        if num_gts == 0:
            ...
            max_overlaps = Tensor(rng.rand(num_preds))

            # Construct gt_inds for each predicted box
            is_assigned = Tensor(rng.rand(num_preds) < p_assigned)
    ...
    def add_gt_(self, gt_labels):
        ...
        if self.labels is not None:
            self.labels = ops.cat([gt_labels, self.labels])